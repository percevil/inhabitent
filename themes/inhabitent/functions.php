...
function red_starter_scripts()
{
	...
	wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css?family=Merriweather&display=swap');

	wp_enqueue_script('search-script', get_template_directory_uri() . '/build/js/script.min.js', array('jquery'), '20151215', true);
